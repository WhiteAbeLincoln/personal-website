...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___templateKey'
  ...
  | 'childrenMdx___frontmatter___seo___author'
  | 'childrenMdx___frontmatter___seo___image'
  | 'childrenMdx___frontmatter___seo___lang'
  | 'childrenMdx___frontmatter___seo___meta'
  | 'childrenMdx___frontmatter___summary___internal'
  ...
  | 'childrenMdx___fields___fileRelativePath'
  | 'childrenMdx___id'
  ...
  | 'childMdx___frontmatter___seo___author'
  | 'childMdx___frontmatter___seo___image'
  | 'childMdx___frontmatter___seo___lang'
  | 'childMdx___frontmatter___seo___meta'
  | 'childMdx___frontmatter___summary___internal'
  ...
  | 'childMdx___fields___fileRelativePath'
  | 'childMdx___id'
...
export type FrontmatterMarkdownFieldFilterInput = {
  internal?: Maybe<StringQueryOperatorInput>;
};
...
export type MdxFieldsEnum =
  ...
  | 'frontmatter___seo___author'
  | 'frontmatter___seo___image'
  | 'frontmatter___seo___lang'
  | 'frontmatter___seo___meta'
  | 'frontmatter___seo___meta___name'
  | 'frontmatter___seo___meta___content'
  | 'frontmatter___summary___internal'
  | 'frontmatter___tags'
  | 'slug'
  | 'body'
  | 'excerpt'
...
export type MdxFrontmatter = {
  ...
  seo?: Maybe<Seo>;
  summary?: Maybe<FrontmatterMarkdownField>;
...
export type MdxFrontmatterFilterInput = {
  ...
  summary?: Maybe<FrontmatterMarkdownFieldFilterInput>;
...
export type SeoFilterInput = {
  ...
  meta?: Maybe<SeoMetaFilterListInput>;
};
...
export type SeoMetaFilterInput = {
  name?: Maybe<StringQueryOperatorInput>;
  content?: Maybe<StringQueryOperatorInput>;
};

export type SeoMetaFilterListInput = {
  elemMatch?: Maybe<SeoMetaFilterInput>;
};
...
export type SitePageFieldsEnum =
  ...
  | 'pluginCreator___pluginOptions___alias____comps'
  ...
  | 'pluginCreator___pluginOptions___markdownNodeType'
...
export type SitePluginFieldsEnum =
  ...
  | 'pluginOptions___alias____comps'
  ...
  | 'pluginOptions___markdownNodeType'
...
export type SitePluginPluginOptions = {
  ...
  markdownNodeType?: Maybe<Scalars['String']>;
...
export type SitePluginPluginOptionsAliasFilterInput = {
  ...
  _comps?: Maybe<StringQueryOperatorInput>;
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  root?: Maybe<StringQueryOperatorInput>;
  markdownNodeType?: Maybe<StringQueryOperatorInput>;
...
export type SeoFragmentFragment = (
  { __typename?: 'SEO' }
  & Pick<Seo, 'description' | 'title' | 'keywords' | 'author' | 'image' | 'lang'>
  & { meta?: Maybe<Array<(
    { __typename?: 'SEOMeta' }
    & Pick<SeoMeta, 'name' | 'content'>
  )>> }
);

export type PortfolioPagesQueryVariables = Exact<{ [key: string]: never; }>;


export type PortfolioPagesQuery = (
  { __typename?: 'Query' }
  & { autoPages: (
    { __typename?: 'MdxConnection' }
    & { nodes: Array<(
      ...
      & { frontmatter?: Maybe<(
        ...
        & { summary?: Maybe<(
          { __typename?: 'FrontmatterMarkdownField' }
          & Pick<FrontmatterMarkdownField, 'body'>
        )> }
      )> }
    )> }
  ), manualPages: (
...
export type SimplePageQueryQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type SimplePageQueryQuery = (
  { __typename?: 'Query' }
  & { mdx?: Maybe<(
    { __typename?: 'Mdx' }
    & Pick<Mdx, 'body'>
